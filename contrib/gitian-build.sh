...
-u|--url	Specify the URL of the repository. Default is https://github.com/Electra-project/electra
...
then
    ...
    git clone https://github.com/Electra-project/gitian.sigs.git
    git clone https://github.com/Electra-project/electra-detached-sigs.git
